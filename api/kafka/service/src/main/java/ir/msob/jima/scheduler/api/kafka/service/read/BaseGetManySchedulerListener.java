...
public interface BaseGetManySchedulerListener<
    ...
    Logger log = LoggerFactory.getLogger(BaseGetManySchedulerListener.class);
    ...
    private void serviceGetMany(String dto) {
        ...
        getService().getMany(message.getData().getCriteria(), user)
                .subscribe(dtos -> sendCallbackDtos(message, dtos, OperationsStatus.GET_MANY, user));
    }
}
