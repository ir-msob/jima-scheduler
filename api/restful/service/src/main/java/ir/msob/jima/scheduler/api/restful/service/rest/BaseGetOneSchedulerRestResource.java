...
public interface BaseGetOneSchedulerRestResource<
    ...
    Logger log = LoggerFactory.getLogger(BaseGetOneSchedulerRestResource.class);
    ...
    @MethodStats
    default ResponseEntity<Mono<JobDto>> getOne(JobCriteria criteria, ServerWebExchange serverWebExchange, Principal principal) throws JsonProcessingException {
        log.debug("REST request to getOne job, criteria {}", criteria);
    ...
    default ResponseEntity<Mono<JobDto>> getOneResponse(Mono<JobDto> result, Optional<USER> user) {
